...
import (
	...
	"github.com/eduartepaiva/go-boilerplate/internal/middleware"
...
func NewHealthHandler(s *server.Server) *HealthHandler {
	return &HealthHandler{Handler: NewHandler(s)}
}
